...
double* VasicekCalculate::CalcVasicekParralel(int iRank, int iSize, vector<double> *vData, double dTimeStep, int n, int iNoOfItrPerMachine, double lastData ){
	...
	vasicekValues=  MonticarloSimulation(iRank, iSize, n, iNoOfItrPerMachine, mu, sigma, lambda, lastData );
...
double* VasicekCalculate::CalcVasicekSequentially(int iRank, int iSize, vector<double> *vData,double dTimeStep, int n, int iNoOfItrPerMachine, double lastData)
{
	int iTag =1;
	MPI_Status mpiStatus;
	double finalParameters[3];
...
double* VasicekCalculate::MonticarloSimulation(int iRank, int iSize, int n, int iNoOfItrPerMachine, double mu, double sigma, double lambda, double lastData )
{
	MPI_Status mpiStatus;
	int iTag = 1;
