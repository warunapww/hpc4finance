...
//////////////////////////////////////////////////////////////////////////
/*
Euler Discretization of CIR is given at http://www.quantcode.com/modules/mydownloads/singlefile.php?cid=9&lid=390
...
CIR::CIR(int argCount, char **args, char* pzDBName, char* pzIP, char* pzUserName, char* pzPW, char* pzDataColumn, double dTimeStep)
{
	i_ArgCount = argCount;
	pz_Args = args;
...
double* CIR::getPredicts(double *dParams)
{
	...
	{	
		CIRModel oCIR(dInitial, dDrift, dSigma, dLambda, d_TimeStep, dSeed);  // our brownian motion object 
...
int main(int argc, char* argv[])
{
  ...
  if (iRc != MPI_SUCCESS)
  {
	...
	for (int i = 0; i < iNoOfItrPerMachine; i++ )
	{
		...
		CIR vasicek_test(pdParams[0], pdParams[1], pdParams[2], pdParams[3], dTimeStep);
		int j;
